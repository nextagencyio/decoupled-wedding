...
const lato = Lato({ subsets: ['latin'], variable: '--font-lato', weight: ['400', '700'], display: 'swap' })
...
export const metadata: Metadata = {
  ...
  description: 'We are so excited to celebrate our love with the people who mean the most to us. Join us for a weekend of joy, laughter, and unforgettable memories in the heart',
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
